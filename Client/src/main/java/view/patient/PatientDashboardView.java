...
import presenter.patient.PatientDashboardPresenter;
...
public class PatientDashboardView {
    ...
    public void setPatientProfile(PatientProfileDTO profile) {
        ...
        patientNameLabel.setText(valueOrDash(profile.getFullName()));
        patientCnpLabel.setText(valueOrDash(profile.getNationalId()));
        patientBirthDateLabel.setText(formatBirthDate(profile.getBirthDate()));
        patientAgeLabel.setText(formatAge(profile.getBirthDate()));
        patientGenderLabel.setText(formatGender(profile.getNationalId()));
        patientPhoneLabel.setText(valueOrDash(profile.getPhone()));
        patientAddressLabel.setText(valueOrDash(profile.getAddress()));
    ...
    private void resetPatientProfile() {
