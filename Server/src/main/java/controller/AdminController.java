...
import model.dto.AdminStatsDTO;
...
public class AdminController {
    ...
    public Response listUsers() {
        try {
            List<AdminUser> users = adminRepository.findAdminUsers();
            return Response.ok(users.stream().map(this::toDto).toList());
        } catch (Exception e) {
